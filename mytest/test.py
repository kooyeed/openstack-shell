...
from mytest import catalog
from mytest.common import kvs
...
class TestCase(NoModule, unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config([etcdir('mytest.conf.sample'),
    ...
    def config(self, config_files):
        CONF(args=[], project='mytest', default_config_files=config_files)
