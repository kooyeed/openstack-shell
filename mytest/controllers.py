...
class Version(wsgi.Application):
    ...
    def _get_identity_url(self, version='v1.0'):
        """Returns a URL to mytest's own endpoint."""
    ...
    def get_version_v1(self, context):
        versions = self._get_versions_list(context)
        if 'v1.0' in _VERSIONS:
            return wsgi.render_response(body={
                'version': versions['v1.0']
            })
        else:
            raise exception.VersionNotFound(version='v1.0')
